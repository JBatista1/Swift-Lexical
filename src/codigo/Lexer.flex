...
"internal"		         { return new Tokens("INTERNAL", yytext(), yyline, yycolumn, "Uma construção de controle de acesso que permite que entidades sejam usadas em qualquer arquivo de origem de seu módulo de definição"); }
...
"public"		            { return new Tokens("PUBLIC", yytext(), yyline, yycolumn, "Uma construção de controle de acesso que permite que os objetos sejam acessíveis e subclassíveis, mas apenas dentro de seu módulo de definição."); }
